...
namespace Skolni_testy.Views.Questions.FreeAnswer
{
    ...
    class TeacherResult : BaseView
    {
        ...
        public override void Render(Dictionary<string, object> data)
        {
            ...
            var markIncorrectBtn = new MaterialFlatButton();
            markIncorrectBtn.Location = new System.Drawing.Point(400, 160);
            markIncorrectBtn.Click += (s, e) => { appContext.Router.SwitchTo("QuestionTypes.FreeAnswer", "MarkCorrect", new Dictionary<string, object> { { "correct", false }, { "answer", answer_m }, { "test", data["test"] } }); Render(data); };
            markIncorrectBtn.Text = t.MarkIncorrect;
            f.Controls.Add(markIncorrectBtn);


            var markCorrectBtn = new MaterialFlatButton();
            markCorrectBtn.Location = new System.Drawing.Point(600, 160);
            markCorrectBtn.Click += (s, e) => { appContext.Router.SwitchTo("QuestionTypes.FreeAnswer", "MarkCorrect", new Dictionary<string, object> { { "correct", true }, { "answer", answer_m }, { "test", data["test"] } }); Render(data); };
            markCorrectBtn.Text = t.MarkCorrect;
            f.Controls.Add(markCorrectBtn);
